...
![Cartographie de la mesure du bonheur dans le monde](images/happiness-ink.png){:width="300px"}
...
![Données mondiales sur le carbone](images/carbon.png){:width="300px"}
...
![PIB](images/gdp.png){:width="300px"}
